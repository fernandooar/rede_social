...
$router->mount('/api', function() use ($router) {
    ...
    //Rota POST /api/usuarios - para cadastrar um novo usuário
    $router->post('/usuarios', UsuarioController::class . '@cadastrar');
    //Rota POST /api/login - para autenticar um usuário
